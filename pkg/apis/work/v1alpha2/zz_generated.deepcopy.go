...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FailoverHistoryItem.
func (in *FailoverHistoryItem) DeepCopy() *FailoverHistoryItem {
	if in == nil {
		return nil
	}
	out := new(FailoverHistoryItem)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ResourceBindingStatus) DeepCopyInto(out *ResourceBindingStatus) {
	*out = *in
	...
	if in.FailoverHistory != nil {
		...
		*out = make([]FailoverHistoryItem, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
