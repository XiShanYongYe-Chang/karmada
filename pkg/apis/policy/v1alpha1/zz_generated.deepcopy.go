...
func (in *ClusterTaintPolicySpec) DeepCopyInto(out *ClusterTaintPolicySpec) {
	*out = *in
	...
	if in.AddOnMatchSeconds != nil {
		in, out := &in.AddOnMatchSeconds, &out.AddOnMatchSeconds
		*out = new(int32)
		**out = **in
	}
	if in.RemoveOnMismatchSeconds != nil {
		in, out := &in.RemoveOnMismatchSeconds, &out.RemoveOnMismatchSeconds
		*out = new(int32)
		**out = **in
	}
	return
